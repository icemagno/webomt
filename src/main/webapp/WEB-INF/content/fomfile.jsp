				...
				<div id="leftBox"> 
					...
					<div id="basicCentralPanel">
						...
						<div style="margin : 10px auto; width : 95%;display:table" >
							...
							<div style="margin: 0 auto;margin-top:10px;min-width: 70px;" title="Edit" onclick="run('${experiment.idExperiment}')" class="basicButton dicas">Edit</div>							
							<div id="cmd" style="margin: 0 auto;margin-top:10px;min-width: 70px;" title="Print" class="basicButton dicas">Print</div>							
											...
											<table>
												<c:forEach var="attr" items="${object.attributes}">
													<tr>
														...
														<td style="width:80px;color:#F90101">${attr.sharing}</td>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#cmd').click(function () {
			window.open("showFomFile?idFederation=${federation.idFederation}&pageType=alternative", "_blank" );
		});
